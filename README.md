...
* [openivno-ai-plugins-gimp](https://github.com/intel/openvino-ai-plugins-gimp) - GIMP AI plugins with OpenVINO Backend. Provides a stable diffusion plugin to the GIMP open source image ditor.
...
<<<<<<< HEAD
* [JAMU](https://github.com/stefan-zobel/JAMU) -  JAMU - Java Matrix Utilities built on top of Intel's oneAPI Math Kernel Library (oneMKL).
